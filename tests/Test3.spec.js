...
test('Adactin Login Assertion', async({page})=>
    {
        //login page
        await page.goto("https://adactinhotelapp.com/");
        await expect(page).toHaveTitle("Adactin.com - Hotel Reservation System");
        await page.locator('id=username').fill('gulshifamansoori');
        await page.locator('id=password').fill('Gul@2024');
        await page.locator('id=login').click();
        const msg = await (await page.locator('//input[@id="username_show"]').getAttribute('value'));
        expect(msg).toBe('Hello gulshifamansoori!');
        ...
        await page.locator('//input[@id="first_name"]').fill('Gulshifa');
        await page.locator('//input[@id="last_name"]').fill('Mansoori');
        await page.locator('//textarea[@id="address"]').fill('Pune');
        ...
        await page.locator("(//input[@type='checkbox'])[2]");
